...
* Starting BizTalk Server 2020, BAM uses SSIS Catalog for deploying and managing BAM DTS packages. Create SSIS Catalog on the target SQL Server before configuration.
...
- Starting BizTalk Server 2020, BAM uses SSIS Catalog for deploying and managing BAM DTS packages (https://docs.microsoft.com/en-us/biztalk/core/bam-dts-packages). Create SSIS Catalog on the target SQL Server (Primary Import and Star Schema database) before configuration using https://docs.microsoft.com/en-us/sql/integration-services/catalog/ssis-catalog?view=sql-server-ver15#create-the-ssis-catalog 
...
- BAM Alerts service requires SQL_AS_ADOMD client to run. Install SQL Server 2016 Analysis Services ADOMD from https://www.microsoft.com/en-us/download/details.aspx?id=52676 .
