...
- BAM Alerts service requires SQL_AS_ADOMD client to run. Install SQL Server 2016 Analysis Services ADOMD from [SQL Server 2016 Feature Pack](https://www.microsoft.com/en-us/download/details.aspx?id=52676).
