...
|Audit Log|Making BizTalk further secure by maintaining audit trails of all management operation.<br/><br/>[Configuring and Viewing Audit Logs](https://docs.microsoft.com/en-us/biztalk/core/audit-management-operations)||  
...
|Additional updates|<ul><li>Move to new long term supported Microsoft OLEDB Driver for SQL Server. </li><br/><li>Support for SSO Affiliate applications in SFTP adapter.</li><br/><li>SQL Availability Group support for BAM DTS Package via SSIS Catalog.</li><br/><li>Partially disabled receive locations.<br/>[How to Enable Receive Location Fault Tolerance](https://docs.microsoft.com/en-us/biztalk/technical-guides/how-to-enable-receivelocation-faulttolerance)</li><br/><li>Throughput improvements for Dynamic Send Ports with Ordered Delivery.</li></ul>|   
